            ...
            <div className="mt-10" id="configuringLayout">
                <div className="mt-10" id="classic">
                    ...
                    <p className="mt-1">
                        ...
                        <code>src/configs/theme.config.js</code> with the string
                        value above
                    </p>
		...
		...
                        ...
                        <div id="classic">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <code>
                                        src/components/template/SideNavToggle.js
                                    </code>
                                </li>
                                <li>
                                    <strong>Search</strong> (optional) -{' '}
                                    <code>
                                        src/components/template/Search.js
                                    </code>
                                </li>
                                <li>
                                    ...
                                    -{' '}
                                    <code>
                                        src/components/template/LanguageSelector.js
                                    </code>
                                </li>
                                <li>
                                    <strong>Notification</strong> (optional) -{' '}
                                    <code>
                                        src/components/template/Notification.js
                                    </code>
                                </li>
                                <li>
                                    <strong>SidePanel</strong> (optional) -{' '}
                                    <code>
                                        src/components/template/SidePanel/index.js
                                    </code>
                                </li>
                                <li>
                                    <strong>UserDropdown</strong> -{' '}
                                    <code>
                                        src/components/template/UserDropdown.js
                                    </code>
                                </li>
                                <li>
                                    <strong>SideNav</strong> -{' '}
                                    <code>
                                        src/components/template/SideNav.js
                                    </code>
                                </li>
                                <li>
                                    <strong>MobileNav</strong> -{' '}
                                    <code>
                                        src/components/template/MobileNav.js
                                    </code>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="stackedSide">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <code>
                                        src/components/template/SplittedSideNav.js
                                    </code>
                                </li>
                                <li>
                                    <strong>MobileNav</strong> -{' '}
                        ...
                        <div id="Simple">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <code>
                                        src/components/template/HeaderLogo.js
                                    </code>
                                </li>
                                <li>
                                    <strong>HorizontalNav</strong> -{' '}
                                    <code>
                                        src/components/template/HorizontalNav.js
                                    </code>
                                </li>
                                <li>
                                    <strong>Search</strong> (optional) -{' '}
                        ...
                        <div id="Decked">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <code>
                                        src/components/template/SecondaryHeader.js
                                    </code>
                                </li>
                                <li>
                                    <strong>Search</strong> (optional) -{' '}
            ...
            <div className="mt-10" id="overridingLayouts">
                ...
                <p className="mt-1">
                    ...
                    layout in <code>theme.config.js</code>. However, if there
        ...
        meta: {
            ...
            <div className="mt-10" id="authLayouts">
                ...
                <p>
                    ...
                    <code>src/components/layout/AuthLayout/index.js</code> and
