...
const TableData = (props) => {
      ...
      const { columns, data, is_location, updateData, in_link = false, locationName } = props;
      ...
      const writeLocatinName = (e, locationName) => {
            ...
            if (locationName == 'Viloyatlar') {
                  const newArr = newLocationArr.filter((el) => el.label != 'Viloyatlar' && el.label != 'Tumanlar' && el.label != 'Maktablar' && el.label != 'Sinflar' && el.label != "O'quvchilar");
                  newLocationArr = newArr;
            } else if (locationName == 'Tumanlar') {
                  const newArr = newLocationArr.filter((el) => el.label != 'Tumanlar' && el.label != 'Maktablar' && el.label != 'Sinflar' && el.label != "O'quvchilar");
                  newLocationArr = newArr;
            } else if (locationName == 'Maktablar') {
                  const newArr = newLocationArr.filter((el) => el.label != 'Maktablar' && el.label != 'Sinflar' && el.label != "O'quvchilar");
                  newLocationArr = newArr;
            } else if (locationName == 'Sinflar') {
                  const newArr = newLocationArr.filter((el) => el.label != 'Sinflar' && el.label != "O'quvchilar");
                  newLocationArr = newArr;
            } else if (locationName == "O'quvchilar") {
                  const newArr = newLocationArr.filter((el) => el.label != "O'quvchilar");
                  newLocationArr = newArr;
            }

            newLocationArr.push(newLocationValue);
            localStorage.setItem('locationUrlName', JSON.stringify(newLocationArr));
      }
                                                ...
                                                {row.cells.map((cell, index) => {
                                                      return (
                                                            <Td
                                                                  ...
                                                                  key={index}
                                                            >
                                                                  {!in_link && index == 1 && props.redirectTo && (
                                                                        <Link
                                                                  ...
                                                                  {(((!in_link ? index != 1 : true) && index != location) ||
                                                                        !props.redirectTo) &&
                                                                        cell.render("Cell")}
                                                            </Td>
                                                      );
